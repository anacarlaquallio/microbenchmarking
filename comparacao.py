...
plt.title('Comparação de Tempos Médios de Encrypt RSA (Cryptography vs Pycrypto)')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('Comparação de Uso de Memória durante Encrypt RSA (Cryptography vs Pycrypto)')
plt.legend()
plt.grid(True)
plt.show()
